...
create TABLE Rendez_vous (
    id_rendez_vous INTEGER NOT NULL AUTO_INCREMENT,
    Date_rendez_vous DATE,
    lieu_rendez_vous VARCHAR(250),
    id_projet INTEGER NOT NULL,
    id_rapport INTEGER DEFAULT NULL,
    PRIMARY KEY(id_rendez_vous),
    FOREIGN KEY(id_projet) REFERENCES Projet(num_projet),
    FOREIGN KEY(id_rapport) REFERENCES Documents(id)
);
drop table rendez_vous;
insert into rendez_vous (Date_rendez_vous, lieu_rendez_vous, id_projet) values ('2020-12-12', 'ENSIAS', 7);
